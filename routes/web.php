...
Route::get('/scoreboard', function () {
    ...
    $acts = \App\Models\Act::where('created_at', '>=', $today)->whereIn('type', ['connected', 'disconnected'])
    ...
    foreach ($acts as $act) {
        ...
        if ($act->type === 'connected') {
            $end = $acts->where('id', '>', $act->id)->where('type', 'disconnected')->first();
            if ($end === NULL) {
