...
class User extends Authenticatable
{
    ...
    {
        return $this
            ->belongsToMany(Workspace::class)
            ->withPivot('role', 'tag_id');
    }
    ...
    public function roles(): \Illuminate\Database\Eloquent\Relations\BelongsToMany
    {
        return $this
            ...
            ->withPivot('workspace_id', 'room_id');
    }
                            ...
                            $workspace = NULL)
    {
        ...
        return [
            ...
            'sum_hours'   => \Carbon\CarbonInterval::minutes($sum_minutes)
                                                   ->cascade()
                                                   ->forHumans(),
            'data'        => $expanded ? $data : [],
    ...
    public function channels()
    {
        ...
        return $workspaces->merge($room)->merge($chats)->values()->toArray();
    }
